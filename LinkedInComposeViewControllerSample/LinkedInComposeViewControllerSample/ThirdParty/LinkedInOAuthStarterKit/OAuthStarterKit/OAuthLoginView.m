...
- (void)accessTokenResult:(OAServiceTicket *)ticket didFinish:(NSData *)data 
{
    ...
    self.loginCompletionHandler(OAuthLoginResultSuccess, self.accessToken, self.consumer);
    /* end */
...
{
    /* Added by Patricia Cesar: May 23, 2013 */
    self.loginCompletionHandler(OAuthLoginResultFail, nil, nil);
    [self dismissModalViewControllerAnimated:YES];
    /* end */
}
